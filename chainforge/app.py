...
def main():
    ...
    serve_parser.add_argument('--secure', 
                              ...
                              default="off",
                              help=("""Encrypts locally stored files with a password. Encryption modes are:\n
                                ...
                                You must provide a password at every startup. Ensure that you save your password somewhere, as it is not stored anywhere. If you lose it, you will not be able to access your files. NOTE: Clicking the 'Export' button in the UI will still export a non-encrypted flow, in case you need to share the file in the normal manner. This setting is only for local storage.""")
                               )
