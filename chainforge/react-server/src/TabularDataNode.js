...
const CellTextarea = ({ cell, handleSaveCell }) => {
  ...
  // At the moment, there's just no way to make this faster --
  // I think something in mantine-react-table relies upon the 'value'
  // prop here, and it must be the same as the cell's value or it does weird things. 
