        ...
        <Tabs defaultValue="api-keys">
          ...
          <Tabs.Panel value="api-keys" pt="xs">
            <Text mb="md" fz="xs" lh={1.15} color="dimmed">
              Note: <b>We do not store your API keys</b> &mdash;not in a cookie,
              localStorage, or server. Because of this,{" "}
              <b>you must set your API keys every time you load ChainForge.</b>{" "}
              ...
              <TextInput
                ...
                description={
                  <span>
                    ...
                    Settings of any Azure OpenAI model you add to a Prompt Node.
                  </span>
                }
          ...
          {APP_IS_RUNNING_LOCALLY() ? (
            <Tabs.Panel value="custom-providers" pt="md">
              <Text mb="md" fz="sm" lh={1.3}>
                ...
                completion functions as Python scripts. (You can even make your
                own settings screen!) To learn more,{" "}
                <a
